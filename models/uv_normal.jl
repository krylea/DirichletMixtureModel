...
function UnivariateNormalKnownSigma(ss::NormalStats)
  p=Normal(ss.m,ss.s2/ss.tw)
  UnivariateNormalKnownSigma(p)
end

function pdf_likelihood(model::UnivariateNormalModel, y::Float64, θ::Tuple{Float64})
